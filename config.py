...
APP_ID = int(os.environ.get("APP_ID", "20348051"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "a2f5b4029b334b4b16e20baf43d55a57")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002852509748"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://remacaf910:remacaf910@cluster0sds.rjnmizh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0sds")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluster0sds")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002684421727"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002859381463"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002802004487"))
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/bolomotu/2937")
